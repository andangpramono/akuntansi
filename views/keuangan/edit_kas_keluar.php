...
<?php if (true) {
    ...
    <div class="box" style="margin-bottom: 15px;">
        <div class="box-header">
            <h2 class="blue"><i class="fa-fw fa fa-bar-chart-o"></i>Edit Kas Keluar</h2>
        </div>
        <div class="box-content">
            <div class="row">
                <div class="col-md-12">
                    <form action="<?= admin_url('keuangan/edit_kas_keluar/'.$kas_keluar->id) ?>" method="post">
                        <div class="form-group">
                            <label>NAP</label>
                            <input type="text" name="nap_id" class="form-control" value="<?= $kas_keluar->nop.' - '.$kas_keluar->nap ?>" readonly=''>
                        </div>
                        <div class="form-group">
                            <label>Harga @</label>
                            <input type="text" name="harga" class="form-control" value="<?= $kas_keluar->harga ?>">
                        </div>
                        <div class="form-group">   
                            <label>Jumlah</label>
                            <input type="text" name="jumlah" class="form-control" value="<?= $kas_keluar->jumlah ?>">
                        </div>
                        <div class="form-group">
                            <label>Q</label>
                            <input type="number" name="q" class="form-control" value="<?= $kas_keluar->quantity ?>">
                        </div>
                        <div class="form-group"> 
                            <label>BKK</label>
                            <input type="text" name="bkk" class="form-control" value="<?= $kas_keluar->bkk ?>">
                        </div>
                        <div class="form-group">
                            <label>Penyetor</label>
                            <input type="text" name="penyetor" class="form-control" value="<?= $kas_keluar->penyetor ?>">
                        </div>
                        <div class="form-group">
                            <label>Bank</label>
                            <input type="text" name="bank" class="form-control" value="<?= $kas_keluar->bank ?>">
                        </div>
                        <div class="form-group">
                            <label>Keterangan</label>
                            <textarea name="ket" class="form-control"><?= $kas_keluar->ket ?></textarea>
                        </div>
