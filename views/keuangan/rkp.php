...
<?php if (true) {
    ...
    <div class="box" style="margin-bottom: 15px;">
        <div class="box-header">
            <h2 class="blue"><i class="fa-fw fa fa-bar-chart-o"></i>RKP (<?= $this->input->get('from').' - '.$this->input->get('to') ?>)</h2>
        </div>
        <div class="box-content">
            <div class="row">
                <div class="col-md-12">
                    <form method="get" action="<?= admin_url('keuangan/rkp') ?>">
                        ...
                        <a class="btn btn-sm btn-success" href="<?= admin_url('keuangan/rkp') ?>">Reset</a>
                    </form>
                    <br>
                    <table class="table table-bordered" >
                        ...
                        foreach ($a1000 as $key => $value):
                            ...
                            $total_akhir+=(float)$value->mts_d-(float)$value->mts_d;
                        ?>
                        <tr class="danger">
                            <td><?= $value->nop ?></td>
                            <td><?= $value->nap ?></td>
                            <TD></TD>
                            <td><?= (float)$value->mts_d ?></td>
                            <td><?= (float)$value->mts_d ?></td>
                            <td><?= (float)$value->mts_d-(float)$value->mts_d ?></td>
                        </tr>
                        <?php endforeach ?>
                         <tr class="danger">
                            <td></td>
                    ...
                    <table class="table table-bordered" >
                        ...
                        $total_k=0;
                        $total_akhir=0;
                        foreach ($a1010 as $key => $value):
                            $total_d += (float)$value->mts_d;
                            $total_k += (float)$value->mts_k;
                            $total_akhir+=(float)$value->mts_k-(float)$value->mts_d;
                        ?>
                        <tr class="info">
                            <td><?= $value->nop ?></td>
                            <td><?= $value->nap ?></td>
                            <TD></TD>
                            <td><?= (float)$value->mts_k ?></td>
                            <td><?= (float)$value->mts_d ?></td>
                    ...
                    <table class="table table-bordered" >
                        ...
                        <tr class="success">
                            ...
                            <td><?= (float)$value->mts_d ?></td>
                            <td><?= (float)$value->mts_k ?></td>
                            <td><?= (float)$value->mts_d-(float)$value->mts_k ?></td>
                        </tr>
                        <?php endforeach ?>
                        <tr class="success">
                            <td></td>
