...
<script>
    $(document).ready(function () {
        oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('keuangan/getkas_keluar') ?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                ...
                nRow.id = aData[0];
                nRow.className = "quote_linkEx";
                return nRow;
            },
            "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": fld}, null, null, null, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, null, null, null,null]
        }).fnSetFilteringDelay().dtFilter([
            {column_number: 1, filter_default_label: "[<?=lang('date');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
            {column_number: 2, filter_default_label: "[NOP]", filter_type: "text", data: []},
            {column_number: 3, filter_default_label: "[TAN]", filter_type: "text", data: []},
            {column_number: 4, filter_default_label: "[Ket]", filter_type: "text", data: []},
            {column_number: 5, filter_default_label: "[Quantity]", filter_type: "text", data: []},
            {column_number: 6, filter_default_label: "[Harga]", filter_type: "text", data: []},
            {column_number: 7, filter_default_label: "[Jumlah]", filter_type: "text", data: []},
            {column_number: 8, filter_default_label: "[BKK]", filter_type: "text", data: []},
            {column_number: 9, filter_default_label: "[Penyetor]", filter_type: "text", data: []},
            {column_number: 10, filter_default_label: "[Bank]", filter_type: "text", data: []},
        ], "footer");
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart-o"></i>Kas Keluar
        </h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('keuangan/add_kas_keluar') ?>">
                                <i class="fa fa-plus-circle"></i> Tambah Kas Keluar
                            </a>
                        </li>
                        <li>
