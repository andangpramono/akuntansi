...
<?php if (true) {
    ...
    <div class="box" style="margin-bottom: 15px;">
        ...
        <div class="box-content">
            <div class="row">
                <div class="col-md-12">
                    <form action="<?= admin_url('keuangan/add_transaction') ?>" method="post">
                        <div class="form-group">
                            <label>Debet</label>
                            <select name="debet" id="qubiller" data-placeholder="Select Biller" required="required" class="form-control input-tip select"  tabindex="-1" title="" data-original-title="Biller" data-bv-field="biller">
                            <?php foreach ($accounts as $key => $value): ?>
                                <option value="<?= $value->account_number ?>"><?= $value->account_number.' - '. $value->name?></option>
                            <?php endforeach ?>
                        ...
                        <div class="form-group">
                            <label>Kredit</label>
                            <select name="kredit" id="qubiller" data-placeholder="Select Biller" required="required" class="form-control input-tip select"  tabindex="-1" title="" data-original-title="Biller" data-bv-field="biller">
                            <?php foreach ($accounts as $key => $value): ?>
                                <option value="<?= $value->account_number ?>"><?= $value->account_number.' - '. $value->name?></option>
                            <?php endforeach ?>
                        ...
                        <div class="form-group"> 
                            <label>BKM</label>
                            <input type="text" name="bkm" class="form-control">
                        </div>
                        <div class="form-group">
