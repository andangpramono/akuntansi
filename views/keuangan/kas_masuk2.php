...
<script>
    $(document).ready(function () {
        oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('keuangan/getkas_masuk') ?>',
            ...
            {column_number: 8, filter_default_label: "[BKM]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart-o"></i>Kas Masuk
        </h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('keuangan/add_kas_masuk') ?>">
                                <i class="fa fa-plus-circle"></i> Tambah Kas Masuk
                            </a>
                        </li>
                        <li>
