...
<?php if (($Owner || $Admin) && $chatData) {
    ...
    <div class="box" style="margin-bottom: 15px;">
        ...
        <div class="box-content">
            <div class="row">
                <div class="col-md-12">
                    <form method="get" action="<?= admin_url('keuangan/general_entries') ?>">
                        <div class="form-group">
                            <label>Bulan</label>
                            <input type="month" name="month" class="form-control" required="">
                        </div>
                        <input class="btn btn-sm btn-success" type="submit" name="ok" value="Filter">
                        <a class="btn btn-sm btn-success" href="<?= admin_url('keuangan/general_entries') ?>">Reset</a>
                    </form>
                    <br>
                    <table width="100%" class="table table-striped">
                        ...
                        <?php foreach ($transactions as $key => $value): ?>
                            ...
                            <tr>
                                <td class="text-right"><?= $value->kredit_name ?></td>
                                <td class="text-center"><?= $value->kredit ?></td>
